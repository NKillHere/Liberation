...
local buildType = mainMenu:label("Build: Neophyte") -- Currently hardcoded, genuienly don't think I can do this in any other way lol, I'll have to make a separate branch for each type of releases.
    :visible(function()
        return tabs:get() == "Main"
    end)
...
local widgetTypes = mainMenu:selectable("Widget Types", "Watermark", "Spectators list", "Keybinds List")
    :visible(function()
...
local widgetBackgroundlabel = mainMenu:label("Widget Background")
    :visible(function()
        return tabs:get() == "Visuals" and widgetTypes:get("Watermark")
    end)
...
local widgetTextlabel = mainMenu:label("Widget Text")
    :visible(function()
        return tabs:get() == "Visuals" and widgetTypes:get("Watermark" or "Spectator list" or "Keybinds List")
    end)
...
local crosshairMain = mainMenu:combo("Main font", "Default", "Bold", "Pixel")
    :visible(function()
        return tabs:get() == "Visuals" and crosshairSwitch:get()
    end)
